...
```powershell
$env:PYTHONUTF8 = "1"
.\scripts\docs\run_examples_all_tiers.ps1 -Examples TI1763-01-002
```
...
|------|------------------|-----|-------|--------------|------------|---------|
| **gid** | `pdf_cmap_fix/data/font_lookup/` | `pdf-cmap-fix` | MATCH | 3352 | 17 | [cli-results/gid](cli-results/gid/) |
| **gname** | `pdf_cmap_fix/data/font_lookup_gname/` | `pdf-cmap-fix-gname` | MATCH | 61 | 1 | [cli-results/gname](cli-results/gname/) |
| **gname_pua_free** | `pdf_cmap_fix/data/font_lookup_gname_pua_free/` | `pdf-cmap-fix-gname` | MATCH | 61 | 1 | [cli-results/gname_pua_free](cli-results/gname_pua_free/) |
| **gshape** | `pdf_cmap_fix/data/font_lookup_gshape/` | `pdf-cmap-fix-gshape` | MATCH | 3347 | 16 | [cli-results/gshape](cli-results/gshape/) |
| **gshape_pua_free** | `pdf_cmap_fix/data/font_lookup_gshape_pua_free/` | `pdf-cmap-fix-gshape` | MATCH | 3347 | 16 | [cli-results/gshape_pua_free](cli-results/gshape_pua_free/) |
| **gid_pua_free** | `pdf_cmap_fix/data/font_lookup_gid_pua_free/` | `pdf-cmap-fix` | MATCH | 3352 | 17 | [cli-results/gid_pua_free](cli-results/gid_pua_free/) |
