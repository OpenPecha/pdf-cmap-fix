...
**PDF:** `docs/examples/sample/sample.pdf`

**About:** Mixed; Jomolhari + Cambria (varies pages)
...
```powershell
pdf-cmap-fix --font-lookup-dir pdf_cmap_fix/data/font_lookup docs/examples/sample/sample.pdf
```

Outputs copied to `docs/examples/sample/cli-results/gid/`.

### gname

```powershell
pdf-cmap-fix-gname --font-lookup-dir pdf_cmap_fix/data/font_lookup_gname docs/examples/sample/sample.pdf
```

Outputs copied to `docs/examples/sample/cli-results/gname/`.

### gname_pua_free

```powershell
pdf-cmap-fix-gname --font-lookup-dir pdf_cmap_fix/data/font_lookup_gname_pua_free docs/examples/sample/sample.pdf
```

Outputs copied to `docs/examples/sample/cli-results/gname_pua_free/`.

### gshape

```powershell
pdf-cmap-fix-gshape --font-lookup-dir pdf_cmap_fix/data/font_lookup_gshape docs/examples/sample/sample.pdf
```

Outputs copied to `docs/examples/sample/cli-results/gshape/`.

### gshape_pua_free

```powershell
pdf-cmap-fix-gshape --font-lookup-dir pdf_cmap_fix/data/font_lookup_gshape_pua_free docs/examples/sample/sample.pdf
```

Outputs copied to `docs/examples/sample/cli-results/gshape_pua_free/`.

### gid_pua_free

```powershell
pdf-cmap-fix --font-lookup-dir pdf_cmap_fix/data/font_lookup_gid_pua_free docs/examples/sample/sample.pdf
```
...
```powershell
pdf-cmap-fix --font-lookup-dir pdf_cmap_fix/data/font_lookup docs/examples/sample/sample.pdf -p
```
